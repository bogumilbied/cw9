...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = (from emp in Emps select emp.Salary);

            var res2 = (from dept in Depts select dept.Deptno);

            var finalRes = res.SelectMany(sal => res2, (s, n) => new
            {
                Pensja = s,
                NumerDept = n
            }).ToList();
